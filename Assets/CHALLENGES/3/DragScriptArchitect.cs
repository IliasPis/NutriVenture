...
public class DragScriptArchitect : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
{
    ...
    if (currentButton != null)
    {
        ...
        if (currentButton == correctButton || currentButton == correctButton2 || currentButton == correctButton3 || currentButton == correctButton4 || currentButton == correctButton5 || currentButton == correctButton6)
        {
   ...
   void MatchingCalculate()
    {
            ...
            if(counter==6 && TotalScore<=4)
            {
                ...
                ScoreShow.text = TotalScore.ToString() + " / 6";
            }

            if(counter==6 && TotalScore>4 && TotalScore<=6)
            {
                MatchingObject.SetActive(false);
                Outcome.SetActive(true);
