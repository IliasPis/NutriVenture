...
public class DragScriptArchitectEnergy : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
{
    ...
    if (currentButton != null)
    {
        ...
        if (currentButton == correctButton || currentButton == correctButton2 || currentButton == correctButton3 || currentButton == correctButton4 || currentButton == correctButton5)
        {
