...
public class DragScriptMaterials : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
{
    ...
    if (currentButton != null)
    {
        ...
        if (currentButton == correctButton || currentButton == correctButton2 || currentButton == correctButton3 || currentButton == correctButton4 )
        {
   ...
   void MatchingCalculate()
    {
            ...
            if(counter==9 && TotalScore>4 && TotalScore<=7)
            {
                MatchingObject.SetActive(false);
                Outcome.SetActive(true);
